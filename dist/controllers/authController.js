...
exports.facultyLogin = exports.Authenticate = exports.Login = void 0;
  ...
  <p>Please use this OTP to verify your account.</p>
    ...
    if (facultyEmailRegex.test(email)) {
        try {
            const emailToken = generateEmailToken();
            const expiration = new Date(new Date().getTime() + EMAIL_TOKEN_EXPIRATION * 60 * 1000);
            faculty_model_1.default.findOne({ email }).then((user) => {
                if (!user) {
                    const newUser = new faculty_model_1.default({
                        email,
                        tokenType: 'EMAIL',
                        token: emailToken,
                        expiration,
